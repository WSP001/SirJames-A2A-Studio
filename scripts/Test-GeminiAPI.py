...
print("  Model: 'gemini-3.0pro' (most stable)")
print("  Alternative: 'gemini-2.5-flash' (faster, cheaper)")
print("  Avoid: 'gemini-3.0-pro' (MAKE available in v1beta API)")
print("\n[NEXT STEP] Update curate-media.ts and narrate-project.ts")
print("  Change: 'gemini-1.5-pro' -> 'gemini-3.0pro'")
